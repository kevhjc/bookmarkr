      ...
      <div className="my-4 w-full rounded border border-blue-200 bg-blue-50 p-4 duration-300 hover:shadow-xl dark:border-gray-600 dark:bg-gray-800">
        ...
        >
          <input
            ...
            className={cn(
              session
                ? 'mt-1 block w-full rounded-md bg-white px-4 py-2 pr-32 text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-700'
                : 'mt-1 block w-full rounded-md bg-gray-200 px-4 py-2 pr-32 dark:bg-gray-800'
            )}
          />
          {session ? (
            <button
              className="w-22 absolute right-1 top-1 flex h-8 items-center justify-center rounded bg-gray-200 px-4 font-medium text-gray-700 transition-all hover:bg-gray-300 dark:bg-gray-300 dark:hover:bg-gray-400"
              type="submit"
            >
              Submit
            </button>
